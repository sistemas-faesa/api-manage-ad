...
class ActiveDirectoryController extends Controller
{
	...
	public function listAllUsers(Request $request)
	{
		...
		$users = $this->connection->query()->select('cn', 'mail', 'samaccountname', 'dateofBirth', 'serialNumber', 'accountexpires')->in($ouQuery)->where('useraccountcontrol', 512)->paginate(100);
