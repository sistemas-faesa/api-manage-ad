...
class AddLdapColumnsToUsersTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('user_ldaps', function (Blueprint $table) use ($driver) {
        ...
        if ($driver === 'sqlsrv') {
            DB::statement(
                $this->compileUniqueSqlServerIndexStatement('user_ldaps', 'guid')
            );
        }
    }
    ...
    {
        Schema::table('user_ldaps', function (Blueprint $table) {
